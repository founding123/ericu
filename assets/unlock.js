(function () {
  ...
  // 현재 문항 페이지 번호 = 파일명 ericuNNNN.html 에서 추출
  ...
  /* ============================================================
     ...
     - passphrase가 없으면(잠긴 ericuNNNN 등) 비밀이 아닌 일반 문구로 대체합니다.
     ============================================================ */
  function escHtml(s) {
  ...
  function applyBranding(site) {
    ...
    // (ericuNNNN 탭 제목은 그 페이지 자신의 <meta name="page-title">을 유지)
    ...
    // ericuNNNN 상단/하단 돌아가기 띠
    fillBackLink(title);
  }

  function applyFallbackBranding() {
    // 잠금 상태에서 보이는 ericuNNNN 돌아가기 띠가 비지 않도록 하는 일반 문구
    fillBackLink('');
  }
